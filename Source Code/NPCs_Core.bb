									...
									If Dist < 0.49 Then
										If Abs(DeltaYaw(n\Collider, me\Collider)) <= 60.0 Then
											...
											Select SelectedDifficulty\OtherFactors
												...
												Case NORMAL
													;[Block]
													InjurePlayer(Rnd(0.48, 0.84), 1.5, 0.0, Rnd(0.12, 0.3), 0.2)
													;[End Block]
												Case HARD
													;[Block]
													InjurePlayer(Rnd(0.56, 0.98), 2.0, 0.0, Rnd(0.14, 0.35), 0.2)
													;[End Block]
													Case EXTREME
													;[Block]
													InjurePlayer(Rnd(0.64, 1.12), 2.5, 0.0, Rnd(0.16, 0.4), 0.2)
													;[End Block]
												Case CAKE
													;[Block]
													InjurePlayer(Rnd(0.28, 0.49), 0.5, 0.0, Rnd(0.07, 0.21), 0.2)
													;[End Block]
												End Select
											If me\Injuries > 3.0 Then
