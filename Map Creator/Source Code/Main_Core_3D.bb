...
Function LoadEntities()
	...
	o\MiscModelID[0] = LoadRMesh("GFX\map\forest\scp_860_1_wall.rmesh", Null)
...
Function LoadRoomTemplateMeshes()
	...
	rt.RoomTemplates = New RoomTemplates
	rt\OBJPath = "GFX\map\hcz\mt1.rmesh"
	rt\Name = MT_Prefix + "endroom"
	rt\Shape = ROOM1
	rt.RoomTemplates = New RoomTemplates
	rt\OBJPath = "GFX\map\hcz\mt2.rmesh"
	rt\Name = MT_Prefix + "corridor"
	rt\Shape = ROOM2
	rt.RoomTemplates = New RoomTemplates
	rt\OBJPath = "GFX\map\hcz\mt2c.rmesh"
	rt\Name = MT_Prefix + "corner"
	rt\Shape = ROOM2C
	rt.RoomTemplates = New RoomTemplates
	rt\OBJPath = "GFX\map\hcz\mt3.rmesh"
	rt\Name = MT_Prefix + "t-shaped room"
	rt\Shape = ROOM3
	rt.RoomTemplates = New RoomTemplates
	rt\OBJPath = "GFX\map\hcz\mt4.rmesh"
	rt\Name = MT_Prefix + "4-way room"
	rt\Shape = ROOM4
	rt.RoomTemplates = New RoomTemplates
	rt\OBJPath = "GFX\map\hcz\mt_elevator.rmesh"
	rt\Name = MT_Prefix + "elevator"
	rt\Shape = ROOM2
	rt.RoomTemplates = New RoomTemplates
	rt\OBJPath = "GFX\map\hcz\mt_generator.rmesh"
